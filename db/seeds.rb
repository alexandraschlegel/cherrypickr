...
# ocado = Supermarket.create!(name: "Ocado", website: "https://www.ocado.com")
seed_products_300 = [{price: '£1.85', name: 'Oatly Foamable 1 Litre'}, {price: '£1.80', name: 'Oatly Oat Drink Whole 1 Litre'},
...
{price: '£1.50', name: 'Oatly H healthy oat dairy-free chocolate'}, {price: '£1.25', name: 'Alpro Unsweetened Oat Drink 1L'}, {price: '£4.5O', name: "Ben & Jerry's Cookie Dough Vanilla Ice Cream 465Ml"}, {price: '£4.5O', name: "Ben And Jerry's Netflix & Chilld Ice Cream 465Ml"}]
  seed_products_300.each do |seed_product|
   if Product.where(name: seed_product[:name]).length > 0
    image_src = Product.where(name: seed_product[:name])[0].image
    Product.create(supermarket: ocado, image: image_src, price: seed_product[:price], name: seed_product[:name])
  end
end


# asda = Supermarket.create!(name: "Asda", website: "https://www.asda.com")
seed_products_200 = [{price: '£1.85', name: 'Oatly Foamable 1 Litre'}, {price: '£1.80', name: 'Oatly Oat Drink Whole 1 Litre'},
{price: '£1.80', name: 'Oatly Oat Drink Semi 1 Litre'}, {price: '£1.80', name: 'Oatly Oat Drink Low Fat'}, {price: '£1.25', name: 'Alpro Oat Unsweetened 1000 Ml'}, {price: '£1.25', name: 'Alpro Oat Drink Alternative 1 Litre'},  {price: '£1.55', name: 'Plenish Organic Oat M*lk'},
{price: '£1.25', name: 'Innocent Oat Dairy Free 750Ml'}, {price: '£1.50', name: 'Rude Health oat drink'}, {price: '£1.55', name: 'Plenish Oat+ Enriched'},
{price: '£1.60', name: 'Alpro Chocolate Oat Drink'}, {price: '£1.00', name: 'Oatly Organic Longlife Drink Alternative 1 Litre'}, {price: '£1.50', name: 'Oatly Chocolate Longlife Drink Alternative 1 Litre'},
...
# OAT PRODUCTS
## SAINSBURYS
seed_products_3 = [{price: '£0.75', name: 'Growers Harvest Porridge Oats'}, {price: '£1.00', name: 'Quaker Oat So Simple Golden Syrup Porridge 57G'}, {price: '£1.00', name: 'Kelloggs Crunchy Nut Chocolate Oat Granola 380G'}, {price: '£1.10', name: 'Oat & Barley Loaf 800G'}, {price: '£2.99', name: 'Quaker Oat Granola Raisin 500G'}, {price: '£2.60', name: 'Activia Grains & Nuts Walnuts & Oats Yogurt 4X120g'}, {price: '£2.50', name: 'Nescafe Gold Oat Latte (6X16g) Gb'}, {price: '£2.60', name: 'Nestle Cheerios Oat Low Sugar Cereal 325G'}, {price: '£3.00', name:'Jordans Crunchy Oat Tropical Fruits Granola 750G'}, {price: '£1.50', name: 'Nomadic Oats Chocolate & Natural Yogurt 169G'}, {price: '£2.50', name: 'Trek Flapjack Cocoa Oat 50G 3 Pack'}, {price: '£2.20', name: 'Quaker Oat So Simple Big Golden Syrup Porridge 6 Pack 298G'}, {price: '£2.00', name: 'Free From Pure Oats 450G'}, {price: '£4.00', name: 'Garnier Ultimate Blends Oat Milk Sensitive Scalp Shampoo 360Ml'}, {price: '£2.50', name: 'Nairns Gluten Free Oat Bar Cacao & Orange 160G'}, {price: '£2.75', name: 'Quaker Oat So Simple Apple & Blueberry Porridge 10 X36g'}, {price: '£1.99', name: 'Belvita Golden Oats Biscuits 225G'}, {price: '£2.50', name: 'Nairns Gluten Free Oat Bar Apple & Cinnamon 160G'}, {price: '£2.75', name: 'Quaker Oat So Simple Sultana Raisin Apple Porridge 10 X38.5G'}, {price: '£1.55', name: 'Oatly Creamy Oat Fraiche 200Ml'}, {price: '£2.75', name: 'Quaker Oat So Simple Protein Original Porridge 8Pk302g'}, {price: '£2.50', name: 'Graze Honey And Oat Bar 4 X 30G'}, {price: '£0.75', name: 'Oomf Protein Oats Golden Syrup Porridge 75G'}, {price: '£3.00', name: 'Stockans Thick Oatcakes 200G (L)'}, {price: '£3.50', name: 'Goodbelly Oat Flakes With Banana & Blueberry 350G'}, {price: '£2.00', name: 'Berry Oat & Flax Seed Smoothie Mix 500G'}, {price: '£2.75', name: 'Fro Oat & Sunflower Seed Crisp Bread 200G'}, {price: '£1.60', name: 'Ryvita Pumpkin & Oats Crisp Bread 4X50g'}, {price: '£1.85', name: 'Mornflake Mighty Creamy Superfast Oats 1.25Kg'}, {price: '£2.75', name: 'Quaker Oat So Simple Protein Golden Syrup Porridge 8X 43G'}, {price: '£2.75', name: 'Quaker Oat So Simple Protein Cinnamon Porridge 8Pack 46G'}]
...
Branch.create(address:'E2 8DY', supermarket: tesco)
#Branch.create(address:'W1D 3RF', supermarket: tesco)
#Branch.create(address:'SW1V 1DT', supermarket: sainsburys)
Branch.create(address: 'E14 4QT', supermarket: waitrose)
#Branch.create(address:'SE17 2DL', supermarket: waitrose)
#Branch.create(address:'SE1 5AG', supermarket: tesco)
...
#Branch.create(address: 'W1J 7UP', supermarket: tesco)
#Branch.create(address: 'WC2R 0AP', supermarket: tesco)
#Branch.create(address: 'WC2R 0AP', supermarket: tesco)
#Branch.create(address: 'WC2R 0AP', supermarket: tesco)
#Branch.create(address: 'SE1 7AA', supermarket: tesco)
#Branch.create(address: 'SE1 8UL', supermarket: tesco)
#Branch.create(address: 'SW1P 2BW', supermarket: tesco)
#Branch.create(address: 'W1D 3RF', supermarket: tesco)
#Branch.create(address: 'WC2R 0AP', supermarket: tesco)

#Branch.create(address: 'N1 6AA', supermarket: tesco)
Branch.create(address: 'E8 4DG', supermarket: tesco)
Branch.create(address: 'E2 7QU', supermarket: tesco)
#Branch.create(address: 'N1 8SY', supermarket: tesco)
#Branch.create(address: 'N1 2EB', supermarket: tesco)
Branch.create(address: 'E1 6HP', supermarket: tesco)
#Branch.create(address: 'N1 8DU', supermarket: tesco)
Branch.create(address: 'EC1V 3AF', supermarket: tesco)
Branch.create(address: 'EC1Y 1AG', supermarket: tesco)

Branch.create(address: 'EC1V 9EY', supermarket: sainsburys)
Branch.create(address: 'E2 8DJ', supermarket: sainsburys)
Branch.create(address: 'EC1Y 1BD', supermarket: sainsburys)
Branch.create(address: 'EC1V 1NR', supermarket: sainsburys)
Branch.create(address: 'E1 6HZ', supermarket: sainsburys)
Branch.create(address: 'E2 7SJ', supermarket: sainsburys)


#Branch.create(address: 'W1A 1EX', supermarket: waitrose)
#Branch.create(address: 'SW1E 6QP', supermarket: waitrose)
#Branch.create(address: 'SW1V 1QT', supermarket: waitrose)
#Branch.create(address: 'SW1E 5DH', supermarket: waitrose)
#Branch.create(address: 'SE1 9LS', supermarket: waitrose)
#Branch.create(address: 'WC1V 7EX', supermarket: waitrose)

Branch.create(address: 'E1 5BW', supermarket: asda)
Branch.create(address: 'E1 4UJ', supermarket: asda)
#Branch.create(address: 'SE1 5AG', supermarket: asda)
Branch.create(address: 'E10 5NH', supermarket: asda)
#Branch.create(address: 'N15 4QD', supermarket: asda)
#Branch.create(address: ' N17 9JF', supermarket: asda)



#Branch.create(address: 'N7 6PL', supermarket: morrisons)
#Branch.create(address: 'N16 5TB', supermarket: morrisons)
#Branch.create(address: 'NW1 8AA', supermarket: morrisons)
#Branch.create(address: 'SE17 2DL', supermarket: morrisons)
Branch.create(address: 'E15 1HP', supermarket: morrisons)
#Branch.create(address: 'SE5 8RR', supermarket: morrisons)
#Branch.create(address: 'SE15 5EW', supermarket: morrisons)
Branch.create(address: 'E16 1ED', supermarket: morrisons)
#Branch.create(address: 'N22 6SU', supermarket: morrisons)
